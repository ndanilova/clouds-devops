...
Для ускорения выполнения пайплайна и во имя избегания лишнего времени на повторные установки зависимостей хороший тон использовать кэширование, чего здесь не наблюдается
